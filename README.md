...
> This API retrieves a random message in json form. Requiesting at the endpoint: /api/v1/message
...
```sh
  cd my-folder
  git clone git@github.com:wandergithub/hello-rails-back-end.git
```
